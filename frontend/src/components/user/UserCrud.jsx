        ...
        <div className="form">
            ...
            <div className="col-12 d-flex justify-content-end">
                <div className="col-12 d-flex justify-content">
                    ...
                    <button className="btn btn-secondary ml-2"onClick={e=>this.clear()}>
                        Cancelar
                    </button>
                </div>
            </div>
                ...
                <tr key = {user.id}>
                    <td>{user.id}</td>
                     ...
                     <td>
                        ...
                        <button className="btn btn-danger ml-2"onClick={()=>this.remove(user)}><i className="fa fa-trash"onClick={()=>this.remove(user)}></i></button>
                    </td>   
                </tr>
            )
        })
